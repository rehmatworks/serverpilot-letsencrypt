...
def main():
	...
	ap.add_argument('-w', '--wild', dest='wildcard', help='Obtain a wildcard SSL certificate. DNS challenge is required.', action='store_const', const=True, default=False, default=False)
